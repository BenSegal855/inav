...
const timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM3, CH1, PB7,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR,  0, 0), // S1 O4 D(1,4,5) 7
    DEF_TIM(TIM3, CH2, PB5,  TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR,  0, 0), // S2 O5 D(1,5,5) 5
    DEF_TIM(TIM4, CH1, PB6,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO,  0, 0), // S3 O6 D(1,0,2) 6
    DEF_TIM(TIM4, CH2, PB4,  TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO,  0, 0), // S4 O7 D(1,3,2) 4
